 ...
 *                       nothing bounds it
 */
public record NamespaceCapacity(Integer podsFree, Long memoryFreeMi, Long cpuFreeMillis, Integer workersFree) {

    public static final NamespaceCapacity UNBOUNDED = new NamespaceCapacity(null, null, null, null);
}
