...
GRANT SELECT ON CPS_METRICS   TO "metricsReader";
GRANT SELECT ON CPS_METRICS_H TO "metricsReader";
GRANT SELECT, DELETE ON CPS_METRICS   TO "metricsPurger";
GRANT SELECT, DELETE ON CPS_METRICS_H TO "metricsPurger";
