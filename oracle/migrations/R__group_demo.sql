...
GRANT SELECT ON DEMO_METRICS   TO METRICS_READER;
GRANT SELECT ON DEMO_METRICS_H TO METRICS_READER;
GRANT SELECT, DELETE ON DEMO_METRICS   TO METRICS_PURGER;
GRANT SELECT, DELETE ON DEMO_METRICS_H TO METRICS_PURGER;
