...
import com.perf.k8sorchestrator.provision.ConditionalOnProvisioningMode;
 ...
 * {@code k8sOrchestrator.pod.lostAfterMs} without a heartbeat, and the claim
...
public class StaticPodProbe {
    ...
    public StaticPodProbe(
            ...
            @Value("${k8sOrchestrator.staticPod.probeConcurrency:8}") int probeConcurrency,
            ...
            // prevent.
            @Value("${k8sOrchestrator.staticPod.probeTickBudgetMs:20000}") long tickBudgetMs) {
        this.pods = pods;
     ...
     */
    @Scheduled(fixedDelayString = "${k8sOrchestrator.staticPod.probeIntervalMs:30000}",
               initialDelayString = "${k8sOrchestrator.staticPod.probeInitialDelayMs:5000}")
    public void probe() {
        try {
