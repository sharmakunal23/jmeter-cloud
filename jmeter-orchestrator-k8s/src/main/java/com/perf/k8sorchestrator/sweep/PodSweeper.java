...
public class PodSweeper {
    ...
    public PodSweeper(
            ...
            @Value("${k8sOrchestrator.pod.lostAfterMs:90000}") long lostAfterMs) {
        this.pods = pods;
        this.runService = runService;
        this.lostAfterMs = lostAfterMs;
    }

    @Scheduled(fixedDelayString = "${k8sOrchestrator.pod.sweepIntervalMs:30000}",
               initialDelayString = "${k8sOrchestrator.pod.sweepInitialDelayMs:30000}")
    public void sweep() {
        try {
