...
public class AiClient {
    ...
    public AiClient(
            ObjectMapper mapper,
            @Value("${k8sOrchestrator.ai.apiKey:}") String apiKey,
            @Value("${k8sOrchestrator.ai.model:claude-sonnet-4-6}") String model,
            @Value("${k8sOrchestrator.ai.baseUrl:https://api.anthropic.com}") String baseUrl,
            @Value("${k8sOrchestrator.ai.maxTokens:512}") int maxTokens) {
        this.mapper = mapper;
        this.model = model;
