...
import com.perf.k8sorchestrator.client.DocumentServiceClient.TemplateUnavailableException;
import com.perf.k8sorchestrator.client.TemplateBody;
...
import com.perf.k8sorchestrator.domain.CronJobFire;
import com.perf.k8sorchestrator.domain.CronJobFireOutcome;
...
import com.perf.k8sorchestrator.email.EmailSender;
import com.perf.k8sorchestrator.http.StartRunRequest;
import com.perf.k8sorchestrator.report.DailyReportComposer;
import com.perf.k8sorchestrator.report.InfraReadinessComposer;
import com.perf.k8sorchestrator.provision.PodRecycler;
import com.perf.k8sorchestrator.provision.PodSpinService;
import com.perf.k8sorchestrator.provision.ProvisioningMode;
...
import com.perf.k8sorchestrator.repo.CronJobFireHistoryRepository;
import com.perf.k8sorchestrator.repo.CronJobRepository;
 ...
 * {@code system} actor).
 *
 * <p>Split deliberately from {@link com.perf.k8sorchestrator.sweep.CronJobScheduler}:
...
public class CronFireService {
    ...
    public CronFireService(CronJobRepository cronJobs,
                           ...
                           @Value("${k8sOrchestrator.automation.reportRecipients:}") String reportRecipientsFallback,
                           @Value("${k8sOrchestrator.automation.maxDueBatch:50}") int maxDueBatch) {
