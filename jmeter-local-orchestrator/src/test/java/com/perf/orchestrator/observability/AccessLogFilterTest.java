...
/** Wiring smoke for local-orch's AccessLogFilter. See jmeter-global-orchestrator's test for full matrix. */
class AccessLogFilterTest {
    ...
    @Test
    void testEndpointEmitsAccessLine() throws Exception {
        ...
        assertThat(appender.list.get(0).getMDCPropertyMap())
                ...
                .containsEntry(AccessLogFilter.MDC_PATH, "/api/v1/test")
