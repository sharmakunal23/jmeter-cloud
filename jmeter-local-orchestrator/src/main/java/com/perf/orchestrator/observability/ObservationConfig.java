 ...
 * so actuator probes don't burn the sampling budget. Kafka producer
 * observations (the streaming pipeline's hot path) are NOT touched —
 * those carry the producer's traceparent through to the consumer.
 */
@Configuration
public class ObservationConfig {
     ...
     * so {@code @Observed}-annotated methods (TestRunManager start / drain
     * / abort) become AOP-wrapped span boundaries.
     */
    @Bean
