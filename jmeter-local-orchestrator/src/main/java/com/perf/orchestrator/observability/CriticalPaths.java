 ...
 * observability stack. Per the singleton-resource design (no path
 * parameters anywhere — no runId in paths),
 * every API path lives under {@code /api/v1}, so a single prefix
